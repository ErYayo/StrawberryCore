...
/// List of Opcodes
/// Not updated opcodes: NUM_MSG_TYPES + i, Max Opcode value in 5.0.4.15913 is 0xFFF
enum Opcodes
{
    ...
    CMSG_CHAT_MESSAGE_RAID                                = 0x1096,
    CMSG_CHAT_MESSAGE_GUILD                               = 0x1096,
    CMSG_CHAT_MESSAGE_OFFICER                             = 0x1096,
    CMSG_CHAT_MESSAGE_YELL                                = 0x1096,
    CMSG_CHAT_MESSAGE_RAID_WARNING                        = 0x1096,
    CMSG_CHAT_MESSAGE_AFK                                 = 0x1096,
    CMSG_CHAT_MESSAGE_BATTLEGROUND                        = 0x1096,
    CMSG_CHAT_MESSAGE_EMOTE                               = 0x1096,
    CMSG_CHAT_MESSAGE_PARTY                               = 0x1096,
    CMSG_CHAT_MESSAGE_WHISPER                             = 0x1096,
    CMSG_CHAT_MESSAGE_SAY                                 = 0x1096,
    CMSG_CHAT_MESSAGE_CHANNEL                             = 0x1096,
    CMSG_CHAT_MESSAGE_DND                                 = 0x1096,
    CMSG_CHAT_ADDON_MESSAGE_BATTLEGROUND                  = 0x1096,
    CMSG_CHAT_ADDON_MESSAGE_WHISPER                       = 0x1096,
    CMSG_CHAT_ADDON_MESSAGE_OFFICER                       = 0x1096,
    CMSG_CHAT_ADDON_MESSAGE_GUILD                         = 0x1096,
    CMSG_CHAT_ADDON_MESSAGE_RAID                          = 0x1096,
    CMSG_CHAT_ADDON_MESSAGE_PARTY                         = 0x1096,
    SMSG_MESSAGE_CHAT                                     = 0x1097,
    ...
    SMSG_ACCOUNT_DATA_INITIALIZED                         = 0x120A,
    ...
    CMSG_UPDATE_PROGRESS_BAR                              = 0x1408,
    ...
    SMSG_PHASE_SHIFT_CHANGE                               = 0x147D,
    ...
    CMSG_READY_FOR_ACCOUNT_DATA_TIMES                     = 0x1500,

...
//                    case 24018: break;
                    case 24210:                             // Mark of Arlokk
                    {
                        ...
                        Strawberry::AllCreaturesOfEntryInRangeCheck check(triggerTarget, 15101, 15.0f);
                        Strawberry::CreatureListSearcher<Strawberry::AllCreaturesOfEntryInRangeCheck> searcher(lList, check);
...
//            }
    ...
    else
    {
        if (Unit* caster = GetCaster())
        {
            if (triggerTarget->GetTypeId() != TYPEID_UNIT || !sEventScriptMgr.OnEffectDummy(caster, GetId(), GetEffIndex(), (Creature*)triggerTarget))
...
void Aura::HandleAuraDummy(bool apply, bool Real)
{
    ...
    if (target->GetTypeId() == TYPEID_UNIT)
        sEventScriptMgr.OnAuraDummy(this, apply);
}
...
//                pCaster->ProcDamageAndSpell(target, procAttacker, procVictim, PROC_EX_NORMAL_HIT, pdamage, BASE_ATTACK, spellProto);
        ...
        case SPELL_AURA_POWER_BURN_MANA:
        {
            ...
            SpellNonMeleeDamage damageInfo(pCaster, target, spellProto->Id, SpellSchoolMask(spellProto->GetSpellSchoolMask()));

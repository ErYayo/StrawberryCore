...
enum SpellCastResult
{
    ...
    SPELL_FAILED_UNKNOWN                        = 203,      // Value not used
...
// will only support WoW, WoW:TBC, WoW:WotLK and WoW:Cataclysm, WoW:MoP 5.0.5a client build 16057...

#define EXPECTED_STRAWBERRYWORLD_CLIENT_BUILD        {16057, 0}

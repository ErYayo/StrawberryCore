...
void InitializeOpcodes()
{
    ...
    OPCODE(CMSG_CHAR_CREATE,                             STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleResponseCharacterCreateOpcode          );
    OPCODE(CMSG_CHAR_ENUM,                               STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleResponseCharacterEnumOpcode            );
    ...
    OPCODE(MSG_TRANSFER_INITIATE,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleEarlyProccess            );
    OPCODE(SMSG_AUTH_CHALLENGE,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::HandleServerSide               );
    OPCODE(CMSG_AUTH_SESSION,                            STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::HandleEarlyProccess            );
    ...
    OPCODE(CMSG_UPDATE_PROGRESS_BAR,                       STATUS_NEVER,    PROCESS_THREADUNSAFE, &WorldSession::HandleEarlyProccess            );
